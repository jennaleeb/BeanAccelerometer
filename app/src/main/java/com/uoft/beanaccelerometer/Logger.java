...
public class Logger {
    ...
    private static final String TAG = "BeanAccelLogger";
    private static final String FOLDER_NAME = "beanaccelerometer";
    private static final String SUBFOLDER_PREFIX = "beanaccelerometer_";
     ...
     * beanaccelerometer/beanaccelerometer_yyyy-MM-dd/filename_yyyy-MM-dd_hh-mm-ss.csv
     *
     * @param filename
     ...
     *         otherwise.
     */
    public boolean initPrintWriter() {
